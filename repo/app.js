(function(){
  ...
  function paradigmHtml(paradigm){
    ...
    let out = `<div class="mw-paradigm"><h3>Склонение</h3><div class="mw-paradigm-grid">`;
    for (const gender in paradigm){
      for (const number in paradigm[gender]){
        const forms = paradigm[gender][number];
